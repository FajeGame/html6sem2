...
class OrderCreationException(message: String, val reason: String) : AppException(message)
...
class ApiExceptionHandler {
    ...
    fun handleAppException(ex: AppException): ResponseEntity<ErrorResponse> {
        val status = when (ex) {
            ...
            is InvalidOrderStateException, is BadRequestException, is OrderCreationException -> HttpStatus.BAD_REQUEST
        }
